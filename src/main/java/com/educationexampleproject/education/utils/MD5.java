...
public final class MD5 {
	 ...
	 * @return
	 */
	private static synchronized MD5 getInstance() {
		if (instance == null)
		{
	...
	public static void main(String[] args) {
		System.out.println(getMD5Str("87gzylxxkjyxgs6150"));
		System.out.println(getMD5Str("87gzylxxkjyxgs1"));
	}
	/**
	 * 将一个字符串进行MD5加密
	 * @param string
	...
	/** 将一个字符串进行MD5加密 */
	private String getMD5ofStr(String string) {
		md5Init();
		md5Update(string.getBytes(), string.length());
		md5Final();
		digestHexStr = "";
		for (int i = 0; i < 16; i++) {
